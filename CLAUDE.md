...
**트리거:** Linux 모니터링, OS 수집, 리포트 생성, 위기 감지, 예측 분석, 대시보드 구축, CLI 구현, QA 검증, 컨테이너 빌드, CI/CD 파이프라인, GitOps 배포 등 모니터링 시스템 관련 작업 요청 시 `k8s-os-monitor` 스킬을 사용하라. 단순 개념 질문은 직접 응답 가능.
